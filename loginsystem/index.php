...
if(isset($_POST['send'])) {
	...
	if($row2>0) {
		...
		//This is a mail function see php.net for more details. It will work if email service is properly configured with php. See php.net for complete details.
...
<head>
	...
	<meta name="keywords" content="Elegent Tab Forms,Login Forms,Sign up Forms,Registration Forms,News letter Forms,Elements" />
